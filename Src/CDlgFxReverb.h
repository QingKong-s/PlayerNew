...
class CDlgFxReverb final :public eck::CDialog
{
private:
	...
	eck::CTrackBar m_TBMix{};
	eck::CTrackBar m_TBTime{};
	eck::CTrackBar m_TBHighFreqRatio{};

	void UpdateCtrl();
public:
	PNInline HWND CreateDlg(HWND hParent, void* pParam) override
	{
		return IntCreateModelessDlg(App->GetHInstance(), MAKEINTRESOURCEW(IDD_REVERB), hParent);
	}
